...
//		System.out.println(principalDetails.getUser().getUsername());
	...
	public String updateForm(@PathVariable int id, Model model) {
		Post postEntiry = postService.상세보기(id);
		model.addAttribute("post", postEntiry);
		return "post/updateForm";
	}
	
	@PostMapping("/post")
	public String save(@Validated PostSaveReqDto postSaveReqDto, @AuthenticationPrincipal PrincipalDetails principalDetails) {
	...
	public String detail(@PathVariable int id, Model model) {
		...
		return "post/detail"; // ViewResolver 발동
	}
